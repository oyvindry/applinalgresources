function filters=liftingfactortho(N, debugMode)
    ...
    [W, A_pre, A_pre_inv] = bw_compute_left(h0, g0, debugMode); % Lower right (3N-1)x(2N) matrix
    ...
    filters.A_R_pre = fliplr(flipud(A_pre));
    filters.A_R_pre_inv = fliplr(flipud(A_pre_inv));
    [WL,A_pre, A_pre_inv] = bw_compute_left(h0, g0, debugMode); % Upper left (3N-1)x(2N) matrix
